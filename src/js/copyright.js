...
function loaderCopy() {
  ...
  const database = {
    stars: 5,
    defaultText: "&copy; LUIS DAS ARTIMANHAS",
    members: ["Pingobras S.A", "Guilherme Antônio"],
    contatos: [
      {
  ...
  let textMembers = database.defaultText;
  ...
  for (let o = 0; o < database.stars - 1; o++) {
  ...
  for (let k = 0; k < database.members.length; k++) {
    const membro = database.members[k];
  ...
  for (let i = 0; i < database.contatos.length; i++) {
    const contato = database.contatos[i];
  ...
  scriptUnpkgElement.setAttribute(
    "src",
    "https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"
  );
  scriptUnpkgNoModuleElement.setAttribute(
    "src",
    "https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.js"
  );
  scriptAvaliacaoElement.setAttribute(
    "src",
    "https://guilhermeantonioo.github.io/site-teste/src/js/script.js"
  );
